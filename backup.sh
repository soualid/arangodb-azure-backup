...
arangodump --server.database keakr --server.endpoint $ARANGODB_ENDPOINT --server.username $ARANGODB_USERNAME --server.password $ARANGODB_PASSWORD --output-directory $outputDirectory
